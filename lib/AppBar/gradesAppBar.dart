...
class GradesAPWidget extends GetView<MyDrawerController>  {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      left: 120,
          ...
          children: [
             Text('Grades', textAlign: TextAlign.center, style: TextStyle(
          color: Color(0xFF3F4A62),
          fontFamily: 'Poppins',
          fontSize: 18,
          fontWeight: FontWeight.w500,
        ),),
        Text('My Grades', textAlign: TextAlign.center, style: TextStyle(
          color: Color(0xFF3F4A62),
          fontFamily: 'Poppins',
          fontSize: 10,
          letterSpacing: 3,
