...
class DepAPWidget extends GetView<MyDrawerController>  {
    ...
    return Stack(
      children: [
        ...
        Positioned(
          ...
          child: Row(children: [
            InkWell(
              onTap: () async {Navigator.of (context).pushNamed("FacultyOf"); },
              child: Container(
               width: 58.0,
                    height: 58.0,
                decoration: BoxDecoration(
      ...
      left: 120,
          ...
          children: [
            Text("Text Department", textAlign: TextAlign.center ,style:TextStyle(
