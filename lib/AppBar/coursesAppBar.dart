...
class CoursesAPWidget extends GetView<MyDrawerController>  {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      left: 150,
          ...
          children: [
             Text('Courses', textAlign: TextAlign.center, style: TextStyle(
          color: Color(0xFF3F4A62),
          fontFamily: 'Poppins',
          fontSize: 18,
          fontWeight: FontWeight.w500,
        ),),
        Text('My Courses', textAlign: TextAlign.center, style: TextStyle(
          color: Color(0xFF3F4A62),
          fontFamily: 'Poppins',
          fontSize: 10,
          letterSpacing: 3,
