...
class Lvl1APWidget extends GetView<MyDrawerController>  {
    ...
    return Stack(
      children: [
        ...
        Positioned(
          ...
          child: Row(children: [
            InkWell(
              onTap: () async {Navigator.of (context).pushNamed("Department"); },
              child: Container(
               width: 58.0,
                    height: 58.0,
                decoration: BoxDecoration(
      ...
      left: 150,
          ...
          children: [
            Text("Level 1", textAlign: TextAlign.center ,style:TextStyle(
